...
| Vitest                      | 84 passed, 0 failed across 13 files, including 27 web tests |
...
| Playwright                  | 1 end-to-end scenario passed in 26.8 seconds                |
...
zero-claim filtering, and sell-gas checks were added.
