...
/// @notice Experimental, self-hosted constant-product pool for GIWA Sepolia only.
/// @dev This testnet contract is unaudited. It intentionally has no liquidity
///      removal path, protocol fee, oracle, flash-swap, or administrative surface.
contract GiwaTestnetConstantProductPool is ERC20, ReentrancyGuard {
    ...
    constructor(IERC20 token_, address adapter_) ERC20("Forge GIWA Testnet LP", "FGTLP") {
        ...
        returns (uint256 amountOut)
    {
        ...
        uint256 inputWithFee = amountIn
            * (ProtocolConstants.BPS_DENOMINATOR - ProtocolConstants.GIWA_TESTNET_SWAP_FEE_BPS);
