...
contract LaunchInvariantHandler {
    ...
    LocalConstantProductAdapter public immutable adapter;
    LaunchToken public immutable token;
    CreatorVestingVault public immutable vault;
    address public immutable creator;

    constructor(
        LocalConstantProductAdapter adapter_,
        LaunchToken token_,
...
contract LaunchInvariantsTest is InvariantTestBase {
    ...
    function setUp() external {
        ...
        handler = new LaunchInvariantHandler(
            adapter, LaunchToken(first.token), CreatorVestingVault(first.vestingVault), CREATOR_ONE
        );
